...
/**
 * @file
 * Installation steps for the profile DocBookWiki.
 */
 ...
 */
function docbookwiki_form_install_configure_form_alter(&$form, $form_state) {
  // Pre-populate the site name with the server name.
  $form['site_information']['site_name']['#default_value'] = 'DocBookWiki';
}

/**
 * Implements hook_install_tasks().
 */
function docbookwiki_install_tasks($install_state) {

  $tasks = array(
    'docbookwiki_mail_config' => array(
      'display_name' => st('Mail Settings'),
      'type' => 'form',
      'run' => INSTALL_TASK_RUN_IF_NOT_COMPLETED,
      'function' => 'docbookwiki_mail_config_form',
    ),
    /*
    'docbookwiki_config' => array(
      'display_name' => st('DocBookWiki Settings'),
      'type' => 'form',
      'run' => INSTALL_TASK_RUN_IF_NOT_COMPLETED,
      'function' => 'docbookwiki_config',
    ),
    */
  );
...
/**
 * General configuration settings for DocBookWiki.
 *
 * @return
...
function docbookwiki_config() {
  ...
  $form['config'] = array(
    '#type'  => 'fieldset',
    '#title' => t('DocBookWiki configuration options'),
  );
 ...
 */
function docbookwiki_mail_config_form($form, $form_state) {
  $form['smtp_on'] = array(
    '#type' => 'checkbox',
  ...
  $form['#submit'] = array('docbookwiki_mail_config_form_submit');
 ...
 */
function docbookwiki_mail_config_form_validate($form, &$form_state) {
 ...
 */
function docbookwiki_mail_config_form_submit($form, &$form_state) {
